...
COMPONENT_FILES	:= on_chip_sram_wrapper.vhd hmac_sha256_32_84.sv hmac_sha256_32_132.sv hmac_sha256_164.sv hmac_sha256_212.sv hmac_sha256_keyhash.sv pbkdf2_80_80_128.sv pbkdf2_80_128_32.sv salsa20_8.sv scratchpad.sv sha256.sv sha256_extension.sv sha256_main.sv scrypt_blockmix.sv

# Specify the name of the top level file (do not include the source folder in the name)
# NOTE: YOU WILL NEED TO SET THIS VARIABLE'S VALUE WHEN WORKING WITH HEIRARCHICAL DESIGNS
# AND THE AUTOMATED GRADING SYSTEM
TOP_LEVEL_FILE	:= scrypt_smix.sv
